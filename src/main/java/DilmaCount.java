...
public class DilmaCount {
	...
	public static class TokenizerMapper extends Mapper<Object, Text, Text, IntWritable> {
		...
		Pattern pattern1 = Pattern.compile("[a-z0-9]+ \\bdilma\\b");
		Pattern pattern2 = Pattern.compile("\\bdilma\\b [a-z0-9]+");
		Pattern pattern3 = Pattern.compile("[a-z0-9]+ \\bdilma\\b [a-z0-9]+");
		Pattern pattern4 = Pattern.compile(" [a-z0-9]+ [a-z0-9]+ \\bdilma\\b");
		Pattern pattern5 = Pattern.compile("\\bdilma\\b [a-z0-9]+ [a-z0-9]+ ");
		Pattern pattern6 = Pattern.compile("\\bdilma\\b [a-z0-9]+ [a-z0-9]+ [a-z0-9]+");
		Pattern pattern7 = Pattern.compile("[a-z0-9]+ [a-z0-9]+ [a-z0-9]+ \\\\bdilma\\\\b");
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(DilmaCount.class);
		...
		job2.setJarByClass(DilmaCount.class);
